...
rdf_graph="""
{
  ...
  "@type": "mdl:SignalRange",
  "mdl:ConditionOperation": ">",
  "mdl:ConditionParameter": [
    {
      "@id": "http://example.org/ConditionParameter1",
      "mdl:ConditionValueFloat": 1500
    },
    {
      "@id": "http://example.org/ConditionParameter2",
...
shacl_shapes_file = "constraints/signal_range.ttl"  # The SHACL shapes in Turtle format
